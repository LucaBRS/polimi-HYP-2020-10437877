...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P1_alfe', '../img/ALESSIO FERRARI.jpg', 'Alessio', 'Ferrari', 'alessio.ferrari@petshoods.com', 'Founder',
...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P2_maam', '../img/MARCO AMADEI.jpg', 'Marco', 'Amadei', 'marco.amadei@petshoods.com', 'Founder',
...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P3_elsa', '../img/ELISA SANTINI.jpg', 'Elisa', 'Santini', 'elisa.santini@petshoods.com', 'Founder',
...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P4_anru', '../img/ANNALISA RUGGI.jpg', 'Annalisa', 'Ruggi', 'annalisa.ruggi@petshoods.com', 
...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P5_crli', '../img/CRISTINA LIGA.jpg', 'Cristina', 'Liga', 'cristina.liga@petshoods.com', 'Vet',
...
INSERT INTO member (id, member_photo, first_name, last_name, email, member_position, member_biography , member_address, member_service) VALUES ('P6_luva', '../img/LUIGI VALLI.jpg', 'Luigi', 'Valli', 'luigi.valli@petshoods.com', 'Vet',
'I graduated in veterinary sciences in 2014 and the following year I decide to become a volunteer for the Petshood association. Being a simple volunteer wasn’t enough for me, so I decide to became an official veterinarian at the Reggio Emilia kennel, so I could help animals in need full time and advise people on how to take care of their new pets. If you want my help ill be always available.',
