...
$('#name').append('<div id="name" class="card-body text-center  "><p>M/D:&emsp;'+data[0].event_month+' / '+data[0].event_day+'</p><img width=100% height=auto src="'+data[3].event_photo+'" alt="event"></img><h3>'+data[0].event_name+'</h3></div><a  class="lucabtn lucabutton text-dark baton" href="./id_event.html?id='+data[0].id_event+'"role="button">See more</a>')
...
$('#name10').append('<div id="name" class="card-body text-center "><p>M/D:&emsp;'+data[10].event_month+' / '+data[10].event_day+'</p><img width=100% height=auto src="'+data[2].event_photo+'"alt="event"></img><h3>'+data[10].event_name+'</h3></div><a   class="lucabtn lucabutton  text-dark baton" href="./id_event.html?id='+data[10].id_event+'"role="button">See more</a>')
...
$('#j1').append('<div id="name"   class="card-body text-center "><p>M/D:&emsp;'+data[0].event_month+' / '+data[0].event_day+'</p><img width=100% height=auto src="'+data[3].event_photo+'"alt="event"></img><h3>'+data[0].event_name+'</h3></div><a   class="lucabtn lucabutton text-dark baton" href="./id_event.html?id='+data[0].id_event+'"role="button">See more</a>')
